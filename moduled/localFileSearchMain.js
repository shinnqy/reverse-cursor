...
!(function () {
  try {
    ...
    n &&
      ...
      (e._sentryDebugIds[n] = "3fd254d4-b027-50a1-ad06-d9e03aa9c77f"))
  } catch (e) {}
})()
var te = function (e, t) {
  return (
...
export function __esDecorate(e, t, r, n, i, s) {
  function l(P) {
  ...
  for (
    ...
    var b = (0, r[m])(o === "accessor" ? { get: c.get, set: c.set } : c[u], v)
    if (o === "accessor") {
...
export function __asyncDelegator(e) {
  ...
  function n(i, s) {
    t[i] = e[i]
      ? function (l) {
          return (r = !r) ? { value: __await(e[i](l)), done: !1 } : s ? s(l) : l
        }
      : s
  }
}
...
export function __disposeResources(e) {
  function t(n) {
    ;(e.error = e.hasError
      ? new Jt(n, e.error, "An error was suppressed during disposal.")
      : n),
      (e.hasError = !0)
  }
  function r() {
...
function Qt(e, t, r = 0, n = e.length) {
  let i = r,
    s = n
  for (; i < s; ) {
    const l = Math.floor((i + s) / 2)
    t(e[l]) ? (i = l + 1) : (s = l)
  }
  return i - 1
}
...
function Yt(e) {
  return e instanceof Xt
    ? !0
    : e instanceof Error && e.name === re && e.message === re
}
var Xt = class extends Error {
    constructor() {
      super(re), (this.name = this.message)
    }
  },
  ne = class ke extends Error {
    constructor(t) {
...
var tr = (e, t) => e - t,
  L2 = class G1 {
    ...
    filter(t) {
      return new G1((r) => this.iterate((n) => (t(n) ? r(n) : !0)))
    }
    map(t) {
      return new G1((r) => this.iterate((n) => r(t(n))))
    }
    some(t) {
      let r = !1
    ...
    findLastMaxBy(t) {
      ...
      return (
        this.iterate(
          (i) => ((n || ie.isGreaterThan(t(i, r))) && ((n = !1), (r = i)), !0),
        ),
        r
      )
    }
...
var Ue = class A1 {
    ...
    constructor(t, r) {
      if (((this[De] = "ResourceMap"), t instanceof A1))
        (this.d = new Map(t.d)), (this.e = r ?? A1.c)
      else if (sr(t)) {
        ;(this.d = new Map()), (this.e = r ?? A1.c)
        for (const [n, i] of t) this.set(n, i)
      } else (this.d = new Map()), (this.e = t ?? A1.c)
    }
    set(t, r) {
  ...
  $2 = class {
    constructor(e, t) {
      ;(this[Me] = "ResourceSet"),
        !e || typeof e == "function"
          ? (this.c = new Ue(e))
          : ((this.c = new Ue(t)), e.forEach(this.add, this))
    }
    get size() {
      return this.c.size
    }
...
;(function (e) {
  ...
  e.from = l
  function* o(y) {
    for (let A = y.length - 1; A >= 0; A--) yield y[A]
  }
  e.reverse = o
  function u(y) {
  ...
  function c(y, A) {
    let x = 0
    for (const j of y) if (A(j, x++)) return !0
    return !1
  }
  e.some = c
  function f(y, A) {
    for (const x of y) if (A(x)) return x
  }
  e.find = f
  function* h(y, A) {
    for (const x of y) A(x) && (yield x)
  }
  e.filter = h
  function* m(y, A) {
    let x = 0
    for (const j of y) yield A(j, x++)
  }
  e.map = m
  function* v(y, A) {
    let x = 0
  ...
  e.flatMap = v
  function* C(...y) {
    for (const A of y) yield* A
  }
  e.concat = C
  function b(y, A, x) {
    let j = x
    for (const T of y) j = A(j, T)
    return j
  }
  e.reduce = b
  function* P(y, A, x = y.length) {
    for (
      A < -y.length && (A = 0),
        A < 0 && (A += y.length),
  ...
  e.slice = P
  function N(y, A = Number.POSITIVE_INFINITY) {
    const x = []
    if (A === 0) return [x, y]
    const j = y[Symbol.iterator]()
    for (let T = 0; T < A; T++) {
      const B = j.next()
  ...
  async function M(y) {
    const A = []
    for await (const x of y) A.push(x)
  ...
  E2 = class Ft {
    ...
    computeLeakingDisposables(t = 10, r) {
      ...
      if (r) n = r
        ...
        const u = new Map(),
          a = [...this.b.values()].filter(
            (f) => f.source !== null && !this.f(f, u).isSingleton,
          )
        if (a.length === 0) return
        const c = new Set(a.map((f) => f.value))
        if (
          ((n = a.filter((f) => !(f.parent && c.has(f.parent)))),
          n.length === 0)
        )
      ...
      function i(u) {
        function a(f, h) {
          for (
            ;
            f.length > 0 &&
            h.some((m) => (typeof m == "string" ? m === f[0] : f[0].match(m)));
...
`),
          ...
          delete C[a[f]]
          for (const [b, P] of Object.entries(C))
            c.unshift(
              `    - stacktraces of ${P.length} other leaks continue with ${b}`,
            )
          c.unshift(h)
        }
        l += `
...
==================== Leaking disposable ${o}/${n.length}: ${u.value.constructor.name} ====================
${c.join(`
`)}
============================================================
...
function hr(e, t) {
  if (m1) for (const r of e) m1.setParent(r, t)
}
function qe(e) {
  if (se.is(e)) {
    const t = []
...
var ue = class qt {
  ...
  N2 = class Z1 {
    static {
      this.Undefined = new Z1(void 0)
    }
    constructor(t) {
      ;(this.element = t),
        (this.next = Z1.Undefined),
        (this.prev = Z1.Undefined)
    }
  },
  mr =
...
;(function (e) {
  ...
  function r(p, d) {
    return m(p, () => {}, 0, void 0, !0, void 0, d)
  }
  e.defer = r
  function n(p) {
    return (d, w = null, g) => {
  ...
  e.onceIf = i
  function s(p, d, w) {
    return f((g, L = null, E) => p((S) => g.call(L, d(S)), null, E), w)
  }
  e.map = s
  function l(p, d, w) {
    return f(
  ...
  e.forEach = l
  function o(p, d, w) {
    return f((g, L = null, E) => p((S) => d(S) && g.call(L, S), null, E), w)
  }
  e.filter = o
  function u(p) {
    return p
  ...
  function a(...p) {
    return (d, w = null, g) => {
      const L = dr(...p.map((E) => E((S) => d.call(w, S))))
      return h(L, g)
    }
  }
  e.any = a
  ...
  function f(p, d) {
    ...
    d || t(g)
    const L = new Z(g)
    return d?.add(L), L.event
  }
  function h(p, d) {
    return d instanceof Array ? d.push(p) : d && d.add(p), p
  }
  function m(p, d, w = 100, g = !1, L = !1, E, S) {
    let U,
      z,
      d1,
      P1 = 0,
  ...
  e.latch = C
  function b(p, d, w) {
    return [e.filter(p, d, w), e.filter(p, (g) => !d(g), w)]
  }
  e.split = b
  function P(p, d = !1, w = [], g) {
    let L = w.slice(),
      E = p((z) => {
        L ? L.push(z) : U.fire(z)
      })
    g && g.add(E)
    const S = () => {
        L?.forEach((z) => U.fire(z)), (L = null)
      },
      U = new Z({
        onWillAddFirstListener() {
          E || ((E = p((z) => U.fire(z))), g && g.add(E))
        },
  ...
  class y {
    ...
    forEach(d) {
      return this.f.push((w) => (d(w), w)), this
    }
    filter(d) {
      return this.f.push((w) => (d(w) ? w : M)), this
    }
    reduce(d, w) {
      let g = w
      return this.f.push((L) => ((g = d(g, L)), g)), this
    }
    latch(d = (w, g) => w === g) {
      let w = !0,
        g
    ...
    evaluate(d) {
      for (const w of this.f) if (((d = w(d)), d === M)) break
      return d
    }
  }
  function A(p, d, w = (g) => g) {
    const g = (...U) => S.fire(w(...U)),
      L = () => p.on(d, g),
      E = () => p.removeListener(d, g),
      S = new Z({ onWillAddFirstListener: L, onDidRemoveLastListener: E })
    return S.event
  }
  e.fromNodeEventEmitter = A
  function x(p, d, w = (g) => g) {
    const g = (...U) => S.fire(w(...U)),
      L = () => p.addEventListener(d, g),
      E = () => p.removeEventListener(d, g),
      S = new Z({ onWillAddFirstListener: L, onDidRemoveLastListener: E })
    return S.event
  }
  e.fromDOMEventEmitter = x
  function j(p) {
    return new Promise((d) => n(p)(d))
  }
  e.toPromise = j
  function T(p) {
    const d = new Z()
  ...
  class c1 {
    constructor(d, w) {
      ...
      w || t(g), (this.emitter = new Z(g)), w && w.add(this.emitter)
    }
    beginUpdate(d) {
      this.f++
    }
  ...
  function ee(p) {
    return (d, w, g) => {
      ...
      return g instanceof ue ? g.add(U) : Array.isArray(g) && g.push(U), U
    }
  }
...
var pr = class Se {
  ...
  wr = class Bt {
    ...
    constructor(t, r, n = (Bt.f++).toString(16).padStart(3, "0")) {
    ...
    check(t, r) {
      ...
      if ((this.g.set(t.value, i + 1), (this.h -= 1), this.h <= 0)) {
        this.h = n * 0.5
        const [s, l] = this.getMostFrequentStack(),
          o = `[${this.name}] potential listener LEAK detected, having ${r} listeners already. MOST frequent listener (${l}):`
...
var Z = class {
    constructor(e) {
      ;(this.z = 0),
        (this.f = e),
        (this.g =
          ze > 0 || this.f?.leakWarningThreshold
            ? new wr(
                e?.onListenerError ?? k1,
                this.f?.leakWarningThreshold ?? ze,
              )
            : void 0),
        (this.j = this.f?._profName ? new pr(this.f._profName) : void 0),
      ...
      return (
        (this.q ??= (e, t, r) => {
          if (this.g && this.z > this.g.threshold ** 2) {
            const o = `[${this.g.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this.z} vs ${this.g.threshold})`
            console.warn(o)
            ...
            return (this.f?.onListenerError || k1)(a), y1.None
          }
          if (this.m) return y1.None
          t && (e = e.bind(t))
          const n = new O1(e)
          let i, s
          this.g &&
            this.z >= Math.ceil(this.g.threshold * 0.2) &&
            ((n.stack = ce.create()), (i = this.g.check(n.stack, this.z + 1))),
            Be && (n.stack = s ?? ce.create()),
            this.u
              ? this.u instanceof O1
                ? ((this.w ??= new Er()), (this.u = [this.u, n]))
                : this.u.push(n)
            ...
            this.z++
          const l = We(() => {
            R1?.unregister(l), i?.(), this.A(n)
          })
          if (
            (r instanceof ue ? r.add(l) : Array.isArray(r) && r.push(l), R1)
          ) {
...
`,
                ...
                .trim(),
              u = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(o)
            R1.register(l, u?.[2] ?? o, l)
          }
          return l
        }),
        this.q
    ...
    B(e, t) {
      if (!e) return
      const r = this.f?.onListenerError || k1
      if (!r) {
        e.value(t)
        return
      }
...
var I1 = class {
    ...
    get onCancellationRequested() {
      return this.a ? He : (this.b || (this.b = new Z()), this.b.event)
    }
    dispose() {
...
var x2 =
  ...
  t1 = globalThis,
  K = void 0
typeof t1.vscode < "u" && typeof t1.vscode.process < "u"
  ? (K = t1.vscode.process)
  : typeof process < "u" &&
    typeof process?.versions?.node == "string" &&
    (K = process)
var Qe = typeof K?.versions?.electron == "string",
  Rr = Qe && K?.type === "renderer"
if (typeof K == "object") {
  ;(D1 = K.platform === "win32"),
  ...
  if (e)
    try {
      ...
      ;(j1 = t.userLocale),
        (Je = t.osLocale),
        (U1 = t.resolvedLanguage || v1),
        (Or = t.languagePack?.translationsConfigFile)
    } catch {}
  Ke = !0
} else
  typeof navigator == "object" && !Rr
    ? ((e1 = navigator.userAgent),
      ...
      (_r =
        (e1.indexOf("Macintosh") >= 0 ||
          e1.indexOf("iPad") >= 0 ||
          e1.indexOf("iPhone") >= 0) &&
        !!navigator.maxTouchPoints &&
        navigator.maxTouchPoints > 0),
      (C1 = e1.indexOf("Linux") >= 0),
      (Sr = e1?.indexOf("Mobi") >= 0),
      (fe = !0),
      (U1 = Ve() || v1),
...
var Ur = typeof t1.postMessage == "function" && !t1.importScripts,
  Fr = (() => {
    if (Ur) {
      const e = []
      t1.addEventListener("message", (r) => {
      ...
      return (r) => {
        ...
        e.push({ id: n, callback: r }),
          t1.postMessage({ vscodeScheduleAsyncWork: n }, "*")
      }
    }
...
if (typeof de < "u" && typeof de.process < "u") {
  const e = de.process
  f1 = {
    get platform() {
      return e.platform
...
function Qr(e, t) {
  if (e === null || typeof e != "object") throw new et(t, "Object", e)
}
function I(e, t) {
...
var D = {
    resolve(...e) {
      ...
      for (let i = e.length - 1; i >= -1; i--) {
        let s
        if (i >= 0) {
          if (((s = e[i]), I(s, `paths[${i}]`), s.length === 0)) continue
        } else
          t.length === 0
            ? (s = F1())
            : ((s = Wr[`=${t}`] || F1()),
        ...
        if (n) {
          if (t.length > 0) break
        } else if (((r = `${s.slice(o)}\\${r}`), (n = a), a && t.length > 0))
          break
      }
      return (r = q1(r, !n, "\\", $)), n ? `${t}\\${r}` : `${t}${r}` || "."
    },
    normalize(e) {
      I(e, "path")
      const t = e.length
      ...
      if ($(s))
        if (((i = !0), $(e.charCodeAt(1)))) {
          ...
          if (o < t && o !== u) {
            ...
            if (o < t && o !== u) {
              for (u = o; o < t && !$(e.charCodeAt(o)); ) o++
              if (o === t) return `\\\\${a}\\${e.slice(u)}\\`
              o !== u && ((n = `\\\\${a}\\${e.slice(u, o)}`), (r = o))
            }
          }
        } else r = 1
      else
      ...
      let l = r < t ? q1(e.slice(r), !i, "\\", $) : ""
      return (
        l.length === 0 && !i && (l = "."),
        l.length > 0 && $(e.charCodeAt(t - 1)) && (l += "\\"),
        n === void 0 ? (i ? `\\${l}` : l) : i ? `${n}\\${l}` : `${n}${l}`
      )
    },
    isAbsolute(e) {
      I(e, "path")
      ...
      return (
        $(r) || (t > 2 && o1(r) && e.charCodeAt(1) === s1 && $(e.charCodeAt(2)))
      )
    },
    join(...e) {
    ...
    relative(e, t) {
      ...
      if (h !== c) {
        ...
        l > c && (e.charCodeAt(i + h) === H ? (f = h) : h === 2 && (f = 3)),
          f === -1 && (f = 0)
      }
      let m = ""
      for (h = i + f + 1; h <= s; ++h)
        (h === s || e.charCodeAt(h) === H) &&
          (m += m.length === 0 ? ".." : "\\..")
      return (
        (o += f),
        m.length > 0
    ...
    toNamespacedPath(e) {
      ...
      if (t.charCodeAt(0) === H) {
        if (t.charCodeAt(1) === H) {
          ...
          if (r !== Jr && r !== i1) return `\\\\?\\UNC\\${t.slice(2)}`
        }
      } else if (
        o1(t.charCodeAt(0)) &&
        t.charCodeAt(1) === s1 &&
  ...
  _ = {
    resolve(...e) {
      ...
      for (let n = e.length - 1; n >= -1 && !r; n--) {
        const i = n >= 0 ? e[n] : Zr()
        I(i, `paths[${n}]`),
          i.length !== 0 && ((t = `${i}/${t}`), (r = i.charCodeAt(0) === F))
      }
      return (t = q1(t, !r, "/", me)), r ? `/${t}` : t.length > 0 ? t : "."
    },
    normalize(e) {
      if ((I(e, "path"), e.length === 0)) return "."
      const t = e.charCodeAt(0) === F,
        r = e.charCodeAt(e.length - 1) === F
      return (
        (e = q1(e, !t, "/", me)),
        e.length === 0
          ? t
    ...
    isAbsolute(e) {
      return I(e, "path"), e.length > 0 && e.charCodeAt(0) === F
    },
    join(...e) {
      if (e.length === 0) return "."
      let t
      for (let r = 0; r < e.length; ++r) {
        const n = e[r]
        I(n, "path"), n.length > 0 && (t === void 0 ? (t = n) : (t += `/${n}`))
      }
    ...
    relative(e, t) {
      if (
        (I(e, "from"),
        I(t, "to"),
        e === t || ((e = _.resolve(e)), (t = _.resolve(t)), e === t))
      )
        return ""
      const r = 1,
        n = e.length,
      ...
      let u = -1,
        a = 0
      for (; a < o; a++) {
        const f = e.charCodeAt(r + a)
        if (f !== t.charCodeAt(s + a)) break
        f === F && (u = a)
      }
      if (a === o)
        if (l > o) {
          if (t.charCodeAt(s + a) === F) return t.slice(s + a + 1)
          if (a === 0) return t.slice(s + a)
        } else
          i > o && (e.charCodeAt(r + a) === F ? (u = a) : a === 0 && (u = 0))
      let c = ""
      for (a = r + u + 1; a <= n; ++a)
        (a === n || e.charCodeAt(a) === F) &&
          (c += c.length === 0 ? ".." : "/..")
...
function cn(e, t, r = 0, n = e.length, i = 0, s = t.length) {
  for (; r < n && i < s; r++, i++) {
...
function nt(e, t, r = 0, n = e.length, i = 0, s = t.length) {
  for (; r < n && i < s; r++, i++) {
    let u = e.charCodeAt(r),
      a = t.charCodeAt(i)
    if (u === a) continue
    if (u >= 128 || a >= 128)
      return cn(e.toLowerCase(), t.toLowerCase(), r, n, i, s)
    it(u) && (u -= 32), it(a) && (a -= 32)
    const c = u - a
    if (c !== 0) return c
  }
...
var F2 = class E1 {
    ...
    static {
      this.d = new on({ getCacheKey: JSON.stringify }, (t) => {
        function r(c) {
          const f = new Map()
        ...
        function n(c, f) {
          const h = new Map(c)
          for (const [m, v] of f) h.set(m, v)
          return h
        }
        function i(c, f) {
          if (!c) return f
          const h = new Map()
          for (const [m, v] of c) f.has(m) && h.set(m, v)
          return h
        }
        const s = this.c.value
        let l = t.filter((c) => !c.startsWith("_") && c in s)
    ...
    static {
      this.e = new ve(() =>
        Object.keys(E1.c.value).filter((t) => !t.startsWith("_")),
      )
    }
    static getLocales() {
      return E1.e.value
...
var O = "",
  ...
  q = class Y1 {
    ...
    with(t) {
      if (!t) return this
      let { scheme: r, authority: n, path: i, query: s, fragment: l } = t
      return (
    ...
    static file(t) {
      let r = O
      if ((g1 && (t = t.replace(/\\/g, G)), t[0] === G && t[1] === G)) {
        const n = t.indexOf(G, 2)
        n === -1
          ? ((r = t.substring(2)), (t = G))
          : ((r = t.substring(2, n)), (t = t.substring(n) || G))
      }
    ...
    static joinPath(t, ...r) {
      ...
      return (
        g1 && t.scheme === "file"
          ? (n = Y1.file(D.join(W1(t, !0), ...r)).path)
          : (n = _.join(t.path, ...r)),
        t.with({ path: n })
      )
    }
      ...
      if (t) {
        if (t instanceof Y1) return t
        {
          ...
          return (
            ...
            (r._fsPath = t._sep === ct ? (t.fsPath ?? null) : null),
            r
          )
        }
      } else return t
...
function pe(e, t) {
  const r = t ? An : ht
  let n = "",
    { scheme: i, authority: s, path: l, query: o, fragment: u } = e
  if (
    (i && ((n += i), (n += ":")),
    (s || i === "file") && ((n += G), (n += G)),
    s)
    ...
    let a = s.indexOf("@")
    if (a !== -1) {
      const c = s.substr(0, a)
      ;(s = s.substr(a + 1)),
        (a = c.lastIndexOf(":")),
        a === -1
          ? (n += r(c, !1, !1))
          : ((n += r(c.substr(0, a), !1, !1)),
            (n += ":"),
            (n += r(c.substr(a + 1), !1, !0))),
        (n += "@")
    }
    ;(s = s.toLowerCase()),
      (a = s.lastIndexOf(":")),
      a === -1
        ? (n += r(s, !1, !0))
        : ((n += r(s.substr(0, a), !1, !0)), (n += s.substr(a)))
  }
  if (l) {
    if (l.length >= 3 && l.charCodeAt(0) === 47 && l.charCodeAt(2) === 58) {
      ...
      a >= 65 &&
        a <= 90 &&
        (l = `/${String.fromCharCode(a + 32)}:${l.substr(3)}`)
    } else if (l.length >= 2 && l.charCodeAt(1) === 58) {
      const a = l.charCodeAt(0)
      a >= 65 &&
        a <= 90 &&
        (l = `${String.fromCharCode(a + 32)}:${l.substr(2)}`)
    }
    n += r(l, !0, !1)
  }
  return (
...
function B1(e) {
  return e.match(mt) ? e.replace(mt, (t) => dt(t)) : e
}
var W
;(function (e) {
  ;(e.inMemory = "inmemory"),
...
var $n = "tkn",
  En = class {
    ...
    rewrite(e) {
      ...
      return (
        typeof i == "string" && (s += `&${$n}=${encodeURIComponent(i)}`),
        q.from({
  ...
  Nn = new En()
function xn(e, t) {
  return _.join(t ?? "/", `${e.quality ?? "oss"}-${e.commit ?? "dev"}`)
}
var Pn = "vscode-app",
  _n = class X1 {
    static {
    ...
    uriToBrowserUri(t) {
      return t.scheme === W.vscodeRemote
        ? Nn.rewrite(t)
        : t.scheme === W.file &&
            (Ir || jr === `${W.vscodeFileResource}://${X1.a}`)
          ? t.with({
...
var L1 = class {
    ...
    compare(e, t, r = !1) {
      return e === t
        ? 0
        : un(this.getComparisonKey(e, r), this.getComparisonKey(t, r))
    }
    isEqual(e, t, r = !1) {
      return e === t
        ? !0
    ...
    normalizePath(e) {
      ...
      return (
        e.scheme === W.file
          ? (t = q.file(Yr(r1(e))).path)
          : (t = _.normalize(e.path)),
        e.with({ path: t })
      )
    }
    relativePath(e, t) {
    ...
    resolvePath(e, t) {
      if (e.scheme === W.file) {
        const r = q.file(en(r1(e), t))
        return e.with({ authority: r.authority, path: r.path })
      }
      return (t = mn(t)), e.with({ path: _.resolve(e.path, t) })
    }
    isAbsolutePath(e) {
    ...
    hasTrailingPathSeparator(e, t = l1) {
      if (e.scheme === W.file) {
        const r = r1(e)
    ...
    removeTrailingPathSeparator(e, t = l1) {
      return bt(e, t)
        ? e.with({ path: e.path.substr(0, e.path.length - 1) })
        : e
    }
    addTrailingPathSeparator(e, t = l1) {
      let r = !1
      if (e.scheme === W.file) {
        const n = r1(e)
      ...
      return !r && !bt(e, t) ? e.with({ path: e.path + "/" }) : e
    }
  },
  k = new L1(() => !1),
  W2 = new L1((e) => (e.scheme === W.file ? !Ze : !0)),
  B2 = new L1((e) => !0),
  z2 = k.isEqual.bind(k),
  ...
  J2 = k.extname.bind(k),
  Q2 = k.dirname.bind(k),
  G2 = k.joinPath.bind(k),
  Z2 = k.normalizePath.bind(k),
...
;(function (e) {
  ...
  function t(r) {
    ...
    const s = r.path.substring(0, r.path.indexOf(";"))
      ...
      return {
        next: async () => {
          do {
            ...
            await S1.toPromise(this.g.event)
          } while (!0)
        },
...
function Le(e, t) {
  ...
  const n = `${r}_${!!t.trimForExclusions}`
  let i = Et.get(n)
  if (i) return xt(i, e)
  let s
  return (
...
function xt(e, t) {
  ...
  const r = function (n, i) {
    return be(n, t.base, !Ze) ? e(ln(n.substr(t.base.length), l1), i) : null
  }
  return (
...
function Wn(e, t) {
  ...
  const i = function (o, u) {
      for (let a = 0, c = r.length; a < c; a++) if (r[a](o, u)) return e
      return null
    },
    s = r.find((o) => !!o.allBasenames)
  s && (i.allBasenames = s.allBasenames)
  const l = r.reduce((o, u) => (u.allPaths ? o.concat(u.allPaths) : o), [])
...
function Hn(e, t) {
  ...
  if (!r.some((o) => !!o.requiresSiblings)) {
    ...
    const o = function (c, f) {
      ...
      u = r.find((c) => !!c.allBasenames)
    u && (o.allBasenames = u.allBasenames)
    const a = r.reduce((c, f) => (f.allPaths ? c.concat(f.allPaths) : c), [])
    return a.length && (o.allPaths = a), o
  }
  const i = function (o, u, a) {
      let c, f
  ...
  if (t) {
    ...
    if (typeof i == "string") {
      const s = (l, o, u, a) => {
        ...
        const c = i.replace("$(basename)", () => u),
          f = a(c)
        return we(f) ? f.then((h) => (h ? e : null)) : f ? e : null
      }
...
function _t(e, t) {
  ...
  if (t) {
    i = []
    for (let o = 0, u = n.length; o < u; o++) i.push(t)
  } else
    i = r.reduce((o, u) => {
      const a = u.patterns
      return a ? o.concat(a) : o
  ...
  const l = e.filter((o) => !o.basenames)
  return l.push(s), l
}
var Kn = class Oe {
    static {
...
`),
    ...
    static rangeAfterEdit(t, r) {
      const n = R.lift(t).whereIs(r.range)
      switch (n) {
        case "overlapping":
          throw new Error(
...
`) -
  ...
  Jn = (e, t, r) => {
    ...
    else if (e[0] === 254 && e[1] === 255)
      n = new TextDecoder("utf-16be").decode(e)
    else if (
      ((n = new TextDecoder("utf8").decode(e)),
      n.slice(0, 1e3).includes("\uFFFD") && e.includes(0))
    )
      return []
    const i = [],
      s = []
    ...
    for (; o >= 0 && (l = t.exec(n)); )
      s.push({ matchStartIndex: l.index, matchedText: l[0] }), o--
    if (s.length) {
      const u = new Set(),
        a = new Set(),
        c = [],
        f = (b) => n.slice(c[b].start, c[b].end)
      let h = 0,
        m = null
      const v = /\r?\n/g
      for (; (m = v.exec(n)); )
        c.push({ start: h, end: m.index }), (h = m.index + m[0].length)
      h < n.length && c.push({ start: h, end: n.length })
      let C = 0
      for (const { matchStartIndex: b, matchedText: P } of s) {
        if (o < 0) break
        for (; c[C + 1] && b > c[C].end; ) C++
        let N = C
        for (; c[N + 1] && b + P.length > c[N].end; ) N++
        if (r.surroundingContext)
          for (let T = Math.max(0, C - r.surroundingContext); T < C; T++)
            u.add(T)
        let M = "",
          y = 0
        for (let T = C; T <= N; T++) {
          let B = f(T)
          r.previewOptions?.charsPerLine &&
...
`),
        ...
        const A = new St(C, b - c[C].start, N, b + P.length - c[N].start),
          x = new St(
            0,
            b - c[C].start - y,
            N - C,
            b + P.length - c[N].start - (N === C ? y : 0),
          ),
          j = { rangeLocations: [{ source: A, preview: x }], previewText: M }
        if ((i.push(j), r.surroundingContext))
          for (
            let T = N + 1;
            T <= Math.min(N + r.surroundingContext, c.length - 1);
            T++
          )
            u.add(T)
      }
      for (const b of u) a.has(b) || i.push({ text: f(b), lineNumber: b + 1 })
    }
    return i
  },
  Qn = class {
    ...
    isArbitraryPathIgnored(e, t) {
      ...
      for (let s = 0; s < r.length; s++) {
        const l = s === r.length - 1,
          o = r[s]
        if (
          ((i = i + "/" + o), !this.isPathIncludedInTraversal(i, l ? t : !0))
        ) {
          n = !0
          break
        }
    ...
    d(e, t, r) {
      const n = e.map((s) => this.f(s, t)),
        i = Object.create(null)
      for (const s of n) i[s] = !0
      return $e(i, { trimForExclusions: r })
    }
    e(e, t, r) {
      const n = e
          .split(
...
`,
          ...
          .map((v) => v.trim())
          .filter((v) => v && v[0] !== "#"),
        i = n.filter((v) => !v.endsWith("/")),
        s = i.filter((v) => !v.includes("!")),
        l = this.d(s, t, !0),
        o = i.filter((v) => v.includes("!")).map((v) => v.replace(/!/g, "")),
        u = this.d(o, t, !1),
        a = n.filter((v) => !v.includes("!")),
        c = this.d(a, t, !0),
        f = n.filter((v) => v.includes("!")).map((v) => v.replace(/!/g, "")),
        h = this.d(f, t, !1)
      return (v, C) =>
        v.startsWith(t)
          ? (C && c(v) && !h(v)) || (l(v) && !u(v))
  ...
  Zn = class Q {
    ...
    static fromString(t, r) {
      return !(r?.dontUseNodeBuffer || !1) && J1
        ? new Q(Buffer.from(t))
        : (Ee || (Ee = new TextEncoder()), new Q(Ee.encode(t)))
    }
    static fromByteArray(t) {
      const r = Q.alloc(t.length)
      for (let n = 0, i = t.length; n < i; n++) r.buffer[n] = t[n]
      return r
    }
    static concat(t, r) {
      if (typeof r > "u") {
        r = 0
        for (let s = 0, l = t.length; s < l; s++) r += t[s].byteLength
      }
      const n = Q.alloc(r)
      let i = 0
    ...
    clone() {
      const t = Q.alloc(this.byteLength)
      return t.set(this), t
    }
    toString() {
      return J1
...
function Yn(e, t, r = 0) {
  ...
  const s = Gn.value
  s.fill(t.length)
  for (let a = 0; a < t.length; a++) s[t[a]] = t.length - a - 1
  let l = r + t.length - 1,
    o = l,
    u = -1
  for (; l < i; )
...
function Q1(e, t = 0) {
  ...
  if (typeof e == "object") {
    ...
    if (e instanceof Zn || e instanceof Uint8Array) return e
    if (Array.isArray(e))
      for (let r = 0; r < e.length; ++r) e[r] = Q1(e[r], t + 1)
    else
      for (const r in e)
        Object.hasOwnProperty.call(e, r) && (e[r] = Q1(e[r], t + 1))
  }
  return e
}
var Ot = !1,
  ...
  p1 = async (e, t) => {
    ...
    const i = await t(),
      s = Date.now()
    return console.info(e, n, "took", s - r), i
  }
function o2(e) {
  return new l2(e)
}
var l2 = class {
  ...
  $cancelQuery(e) {
    this.cancellationTokens.get(e)?.cancel()
  }
  g(e) {
    const t = new Nr()
    return this.cancellationTokens.set(e, t), t
  }
  async $listDirectory(e, t, r, n, i) {
    const s = xe(r),
      l = new L1(() => n),
      o = this.g(i),
      u = []
    let a = !1,
      c = 0
    const f = t.maxResults || 512,
      h = t.filePattern
        ? (m) => t.filePattern.split("").every((v) => m.includes(v))
        : (m) => !0
    return (
      await p1("listDirectory", () =>
        this.h(
          e,
          Tt(t),
          s,
      ...
      { results: u, limitHit: a }
    )
  }
  async $searchDirectory(e, t, r, n, i) {
    const s = xe(r),
      l = new L1(() => n)
    return p1("searchInFiles", async () => {
      const o = this.g(i),
        u = [],
      ...
      const m = !1,
        v = async (C) => {
          ...
          f++
          const b = await C.resolve()
          if (o.token.isCancellationRequested) return
          const P = new Uint8Array(b),
            N = Jn(P, a, {
              surroundingContext: t.surroundingContext ?? 0,
              previewOptions: t.previewOptions,
              remainingResultQuota: t.maxResults ? t.maxResults - h : 1e4,
            })
          if (N.length) {
            ;(h += N.length), t.maxResults && h > t.maxResults && o.cancel()
            const M = { resource: q.joinPath(s.folder, C.path), results: N }
            this.d.$sendTextSearchMatch(M, i), u.push(M)
          }
        }
      return (
        await p1("walkFolderToResolve", () =>
          this.h(e, Tt(t), s, l, async (C) => c.push(v(C)), o.token),
        ),
        await p1("resolveOngoingProcesses", () => Promise.all(c)),
        Ot && console.log("Searched in", f, "files"),
        { results: u, limitHit: m }
      )
    })
  }
  async h(e, t, r, n, i, s) {
    const l = r.excludePattern?.map((b) =>
        $e(b.pattern ?? {}, { trimForExclusions: !0 }),
      ),
      o = (b, P, N) => l?.some((M) => M(b, P, N)),
      u = (b, P, N) => ((b = b.slice(1)), !!(o(b, P, N) || u2(t, b))),
      a = (b, P, N) => ((b = b.slice(1)), !(o(b, P, N) || !c2(t, b, n))),
      c = (b, P) => ({
        type: "file",
        name: b.name,
        path: P,
        resolve: () => b.getFile().then((M) => M.arrayBuffer()),
      }),
      f = (b) => b.kind === "directory",
      h = (b) => b.kind === "file",
      m = async (b, P, N) => {
        if (!r.disregardIgnoreFiles) {
          const y = await Promise.all([
            b.getFileHandle(".gitignore").catch((A) => {}),
            b.getFileHandle(".ignore").catch((A) => {}),
          ])
          await Promise.all(
            y.map(async (A) => {
              if (!A) return
              const x = new TextDecoder("utf8").decode(
                new Uint8Array(await (await A.getFile()).arrayBuffer()),
              )
              N = new Qn(x, P, N)
            }),
          )
        }
        const M = Ce.withAsyncBody(async (y) => {
          const A = [],
            x = [],
            j = [],
            T = new Set()
          for await (const B of b.entries()) j.push(B), T.add(B[0])
          for (const [B, u1] of j) {
            if (s.isCancellationRequested) break
            const c1 = P + B
            if (N && !N.isPathIncludedInTraversal(c1, u1.kind === "directory"))
              continue
            const x1 = (ee) => T.has(ee)
            f(u1) && !u(c1, B, x1)
              ? x.push(m(u1, c1 + "/", N))
              : h(u1) && a(c1, B, x1) && A.push(c(u1, c1))
          }
          y([...(await Promise.all(x)), ...A])
        })
        return { type: "dir", name: b.name, entries: M }
      },
      v = async (b, P) => {
        s.isCancellationRequested ||
          (await Promise.all(
            (await b.entries)
              ...
              .map(async (N) => (N.type === "dir" ? v(N, P) : P(N))),
          ))
      },
      C = await p1("process", () => m(e, "/"))
    await p1("resolve", () => v(C, i))
  }
}
function a2(e) {
...
function xe(e) {
  return Q1({
    ...Q1(e),
    excludePattern: e.excludePattern?.map((t) => ({
...
function Tt(e) {
  return {
    ...e,
    extraFileResources: e.extraFileResources?.map((t) => q.revive(t)),
    folderQueries: e.folderQueries.map((t) => xe(t)),
  }
}
function u2(e, t) {
  ...
  return e.excludePattern && K1(e.excludePattern, t)
    ...
    : e.includePattern || e.usingSearchPaths
      ? e.includePattern && K1(e.includePattern, t)
        ...
        : e.usingSearchPaths
          ? !!e.folderQueries &&
            e.folderQueries.some((n) => {
              const i = n.folder,
                s = q.file(t)
              if (r.isEqualOrParent(s, i)) {
                const l = rt(i.path, s.path)
                return !n.includePattern || !!K1(n.includePattern, l)
              } else return !1
            })
          : !1
      : !0
  ...
  g2 = class {
    ...
    sendMessage(e, t, r) {
      ...
      return new Promise((i, s) => {
        ;(this.c[n] = { resolve: i, reject: s }),
          this.o(new h2(this.a, n, e, t, r))
      })
    }
    listen(e, t, r) {
      let n = null
      const i = new Z({
        onWillAddFirstListener: () => {
          ;(n = String(++this.b)),
            this.d.set(n, i),
            this.o(new d2(this.a, n, e, t, r))
        },
        onDidRemoveLastListener: () => {
          this.d.delete(n), this.o(new v2(this.a, n)), (n = null)
        },
      })
      return i.event
    }
      ...
      const r = {
        get: (n, i) => (
          typeof i == "string" &&
            !n[i] &&
            (jt(i)
              ? (n[i] = (s) => this.listen(e, i, s))
              : Mt(i)
                ? (n[i] = this.listen(e, i, void 0))
                : i.charCodeAt(0) === 36 &&
                  (n[i] = async (...s) => (
                    await t?.(), this.sendMessage(e, i, s)
                  ))),
          n[i]
        ),
      }
    ...
    k(e) {
      ...
      this.g.handleMessage(e.channel, e.method, e.args).then(
        (n) => {
          this.o(new Dt(this.a, t, n, void 0))
        },
        (n) => {
          n.detail instanceof Error && (n.detail = Te(n.detail)),
            this.o(new Dt(this.a, t, void 0, Te(n)))
        },
      )
    }
    l(e) {
...
var b2 = class {
    ...
    g(e, t, r) {
      ...
      const n = e === Pe ? this.b : this.d.get(e)
      if (!n)
    ...
    async j(e, t, r) {
      ...
      return (
        ...
        import(`${kn.asBrowserUri(`${r}.js`).toString(!0)}`).then((i) => {
...
//# sourceMappingURL=https://cursor-sourcemaps.s3.amazonaws.com/sourcemaps/f5f18731406b73244e0558ee7716d77c8096d150/core/vs/workbench/services/search/worker/localFileSearchMain.js.map

//# debugId=3fd254d4-b027-50a1-ad06-d9e03aa9c77f
