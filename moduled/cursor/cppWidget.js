...
export function createCppWidget(params) {
  const { V, oR, N, zT, Ye, f_, g_, p_, G: Range, q, W: createElement, Yy, U: URI, hu, __decorate, __param, Pt, ve, Z: instantiationService, ei: reactiveStorageService, si, qi, Hi, Ds, Ce: contextKeyService, Me, DKi, eI, ge, R, rt, Jl, pl, Ic, a0, oT: StringBuilder, f3, b4, np, K3: renderLine, J3: RenderLineInput, B4, bf, _v, OFt: calculateGreenRanges, CppIntent, k7: SUGGESTION_DISPLAY_TYPE, f: getMessage, ss: getWindow, aiFeatureStatusService, ue, cppService, st, cursorPredictionService, importPredictionService, Ai, Jon, Zt, so, me, Tn, calculateInlineChanges, computeDiffs } = params;
