...
!(function () {
  try {
    ...
    n &&
      ...
      (e._sentryDebugIds[n] = "3c4af479-50e6-56c2-91e4-d37018decbfa"))
  } catch (e) {}
})()
var H1 = function (e, t) {
  return (
...
export function __esDecorate(e, t, r, n, i, s) {
  ...
  for (
    ...
    var T = (0, r[w])(l === "accessor" ? { get: f.get, set: f.set } : f[u], x)
    if (l === "accessor") {
...
export function __asyncGenerator(e, t, r) {
  ...
  function a(w) {
    w.value instanceof __await
      ? Promise.resolve(w.value.v).then(f, c)
      : d(s[0][2], w)
  }
  function f(w) {
    u("next", w)
...
export function __asyncDelegator(e) {
  ...
  function n(i, s) {
    t[i] = e[i]
      ? function (o) {
          return (r = !r) ? { value: __await(e[i](o)), done: !1 } : s ? s(o) : o
        }
      : s
  }
}
...
export function __disposeResources(e) {
  function t(n) {
    ;(e.error = e.hasError
      ? new Pt(n, e.error, "An error was suppressed during disposal.")
      : n),
      (e.hasError = !0)
  }
  function r() {
...
function Tt(e) {
  return e instanceof Rt
    ? !0
    : e instanceof Error && e.name === B1 && e.message === B1
}
var Rt = class extends Error {
    constructor() {
      super(B1), (this.name = this.message)
    }
  },
  J1 = class ce extends Error {
    constructor(t) {
...
var Un =
  ...
  Y = globalThis,
  V = void 0
typeof Y.vscode < "u" && typeof Y.vscode.process < "u"
  ? (V = Y.vscode.process)
  : typeof process < "u" &&
    typeof process?.versions?.node == "string" &&
    (V = process)
var pe = typeof V?.versions?.electron == "string",
  zt = pe && V?.type === "renderer"
if (typeof V == "object") {
  ;(_1 = V.platform === "win32"),
  ...
  if (e)
    try {
      ...
      ;(S1 = t.userLocale),
        (ge = t.osLocale),
        (P1 = t.resolvedLanguage || c1),
        (qt = t.languagePack?.translationsConfigFile)
    } catch {}
  be = !0
} else
  typeof navigator == "object" && !zt
    ? ((G = navigator.userAgent),
      (_1 = G.indexOf("Windows") >= 0),
      (x1 = G.indexOf("Macintosh") >= 0),
      (jt =
      ...
      (b1 = G.indexOf("Linux") >= 0),
      (Dt = G?.indexOf("Mobi") >= 0),
      (K1 = !0),
      (P1 = ve() || c1),
      (S1 = navigator.language.toLowerCase()),
      (ge = S1))
...
var G1 = 0
x1 ? (G1 = 1) : _1 ? (G1 = 3) : b1 && (G1 = 2)
var f1 = _1,
  Wt = x1,
  Ft = b1,
  Vt = be,
  ye = K1,
  Ht = K1 && typeof Y.importScripts == "function",
  Bt = Ht ? Y.origin : void 0,
  J = G,
  Q = P1,
  Ce
;(function (e) {
...
var Jt = typeof Y.postMessage == "function" && !Y.importScripts,
  Kt = (() => {
    if (Jt) {
      const e = []
      ...
      return (r) => {
        ...
        e.push({ id: n, callback: r }),
          Y.postMessage({ vscodeScheduleAsyncWork: n }, "*")
      }
    }
...
var Gt = !!(J && J.indexOf("Chrome") >= 0),
  Dn = !!(J && J.indexOf("Firefox") >= 0),
  qn = !!(!Gt && J && J.indexOf("Safari") >= 0),
...
function Zt(e, t, r = 0, n = e.length) {
  let i = r,
    s = n
  for (; i < s; ) {
...
var er = (e, t) => e - t,
  Hn = class q1 {
    ...
    filter(t) {
      return new q1((r) => this.iterate((n) => (t(n) ? r(n) : !0)))
    }
    map(t) {
      return new q1((r) => this.iterate((n) => r(t(n))))
    }
    some(t) {
      let r = !1
    ...
    findLastMaxBy(t) {
      ...
      return (
        this.iterate(
          (i) => ((n || Y1.isGreaterThan(t(i, r))) && ((n = !1), (r = i)), !0),
        ),
        r
      )
    }
...
var _e = class w1 {
    ...
    constructor(t, r) {
      if (((this[Ae] = "ResourceMap"), t instanceof w1))
        (this.d = new Map(t.d)), (this.e = r ?? w1.c)
      else if (rr(t)) {
        ;(this.d = new Map()), (this.e = r ?? w1.c)
        for (const [n, i] of t) this.set(n, i)
      } else (this.d = new Map()), (this.e = t ?? w1.c)
    }
    set(t, r) {
...
;(function (e) {
  ...
  e.from = o
  function* l(p) {
    for (let L = p.length - 1; L >= 0; L--) yield p[L]
  }
  e.reverse = l
  function u(p) {
  ...
  function f(p, L) {
    let $ = 0
    for (const D of p) if (L(D, $++)) return !0
    return !1
  }
  e.some = f
  function c(p, L) {
    for (const $ of p) if (L($)) return $
  }
  e.find = c
  function* d(p, L) {
    for (const $ of p) L($) && (yield $)
  }
  e.filter = d
  function* w(p, L) {
    let $ = 0
    for (const D of p) yield L(D, $++)
  }
  e.map = w
  function* x(p, L) {
    let $ = 0
  ...
  e.flatMap = x
  function* M(...p) {
    for (const L of p) yield* L
  }
  e.concat = M
  function T(p, L, $) {
    let D = $
    for (const a1 of p) D = L(D, a1)
    return D
  }
  e.reduce = T
  function* F(p, L, $ = p.length) {
    for (
      L < -p.length && (L = 0),
        L < 0 && (L += p.length),
  ...
  e.slice = F
  function V1(p, L = Number.POSITIVE_INFINITY) {
    const $ = []
    if (L === 0) return [$, p]
    const D = p[Symbol.iterator]()
    for (let a1 = 0; a1 < L; a1++) {
      const N1 = D.next()
      ...
      if (r) n = r
        ...
        const u = new Map(),
          a = [...this.b.values()].filter(
            (c) => c.source !== null && !this.f(c, u).isSingleton,
          )
        if (a.length === 0) return
        const f = new Set(a.map((c) => c.value))
        if (
          ((n = a.filter((c) => !(c.parent && f.has(c.parent)))),
          n.length === 0)
        )
      ...
      function i(u) {
        function a(c, d) {
          for (
            ;
            c.length > 0 &&
            d.some((w) => (typeof w == "string" ? w === c[0] : c[0].match(w)));
...
`),
          ...
          delete M[a[c]]
          for (const [T, F] of Object.entries(M))
            f.unshift(
              `    - stacktraces of ${F.length} other leaks continue with ${T}`,
            )
          f.unshift(d)
        }
        o += `
...
function or(e, t) {
  if (h1) for (const r of e) h1.setParent(r, t)
}
function Se(e) {
  if (k1.is(e)) {
    const t = []
...
var ee = class pt {
    ...
    dispose() {
      this.g || (Z1(this), (this.g = !0), this.clear())
    }
    get isDisposed() {
      return this.g
    }
  ...
  ar = class {
    constructor() {
      ;(this.a = P.Undefined), (this.b = P.Undefined), (this.c = 0)
    }
    get size() {
      return this.c
    }
    ...
    d(e, t) {
      const r = new P(e)
      if (this.a === P.Undefined) (this.a = r), (this.b = r)
      else if (t) {
        const i = this.b
        ;(this.b = r), (r.prev = i), (i.next = r)
      } else {
        const i = this.a
        ;(this.a = r), (r.next = i), (i.prev = r)
      }
      this.c += 1
      let n = !1
      return () => {
    ...
    e(e) {
      if (e.prev !== P.Undefined && e.next !== P.Undefined) {
        ...
        e.prev === P.Undefined && e.next === P.Undefined
          ? ((this.a = P.Undefined), (this.b = P.Undefined))
          : e.next === P.Undefined
            ? ((this.b = this.b.prev), (this.b.next = P.Undefined))
            : e.prev === P.Undefined &&
              ((this.a = this.a.next), (this.a.prev = P.Undefined))
      this.c -= 1
    }
    *[Symbol.iterator]() {
      let e = this.a
...
;(function (e) {
  ...
  function r(v, h) {
    return w(v, () => {}, 0, void 0, !0, void 0, h)
  }
  e.defer = r
  function n(v) {
    return (h, b = null, m) => {
  ...
  e.onceIf = i
  function s(v, h, b) {
    return c((m, g = null, C) => v((A) => m.call(g, h(A)), null, C), b)
  }
  e.map = s
  function o(v, h, b) {
    return c(
  ...
  e.forEach = o
  function l(v, h, b) {
    return c((m, g = null, C) => v((A) => h(A) && m.call(g, A), null, C), b)
  }
  e.filter = l
  function u(v) {
    return v
  ...
  function a(...v) {
    return (h, b = null, m) => {
      const g = lr(...v.map((C) => C((A) => h.call(b, A))))
      return d(g, m)
    }
  }
  e.any = a
  ...
  function c(v, h) {
    ...
    h || t(m)
    const g = new K(m)
    return h?.add(g), g.event
  }
  function d(v, h) {
    return h instanceof Array ? h.push(v) : h && h.add(v), v
  }
  function w(v, h, b = 100, m = !1, g = !1, C, A) {
    let I,
      U,
      u1,
      A1 = 0,
  ...
  e.latch = M
  function T(v, h, b) {
    return [e.filter(v, h, b), e.filter(v, (m) => !h(m), b)]
  }
  e.split = T
  function F(v, h = !1, b = [], m) {
    let g = b.slice(),
      C = v((U) => {
        g ? g.push(U) : I.fire(U)
      })
    m && m.add(C)
    const A = () => {
        g?.forEach((U) => I.fire(U)), (g = null)
      },
      I = new K({
        onWillAddFirstListener() {
          C || ((C = v((U) => I.fire(U))), m && m.add(C))
        },
  ...
  class p {
    ...
    forEach(h) {
      return this.f.push((b) => (h(b), b)), this
    }
    filter(h) {
      return this.f.push((b) => (h(b) ? b : l1)), this
    }
    reduce(h, b) {
      let m = b
      return this.f.push((g) => ((m = h(m, g)), m)), this
    }
    latch(h = (b, m) => b === m) {
      let b = !0,
        m
    ...
    evaluate(h) {
      for (const b of this.f) if (((h = b(h)), h === l1)) break
      return h
    }
  }
  function L(v, h, b = (m) => m) {
    const m = (...I) => A.fire(b(...I)),
      g = () => v.on(h, m),
      C = () => v.removeListener(h, m),
      A = new K({ onWillAddFirstListener: g, onDidRemoveLastListener: C })
    return A.event
  }
  e.fromNodeEventEmitter = L
  function $(v, h, b = (m) => m) {
    const m = (...I) => A.fire(b(...I)),
      g = () => v.addEventListener(h, m),
      C = () => v.removeEventListener(h, m),
      A = new K({ onWillAddFirstListener: g, onDidRemoveLastListener: C })
    return A.event
  }
  e.fromDOMEventEmitter = $
  function D(v) {
    return new Promise((h) => n(v)(h))
  }
  e.toPromise = D
  function a1(v) {
    const h = new K()
...
var hr = class fe {
  ...
  dr = class yt {
    ...
    constructor(t, r, n = (yt.f++).toString(16).padStart(3, "0")) {
    ...
    check(t, r) {
      ...
      if ((this.g.set(t.value, i + 1), (this.h -= 1), this.h <= 0)) {
        ...
        const [s, o] = this.getMostFrequentStack(),
          l = `[${this.name}] potential listener LEAK detected, having ${r} listeners already. MOST frequent listener (${o}):`
...
var K = class {
    constructor(e) {
      ;(this.z = 0),
        (this.f = e),
        (this.g =
          Te > 0 || this.f?.leakWarningThreshold
            ? new dr(
                e?.onListenerError ?? $1,
                this.f?.leakWarningThreshold ?? Te,
              )
            : void 0),
        (this.j = this.f?._profName ? new hr(this.f._profName) : void 0),
      ...
      return (
        (this.q ??= (e, t, r) => {
          if (this.g && this.z > this.g.threshold ** 2) {
            ...
            return (this.f?.onListenerError || $1)(a), g1.None
          }
          if (this.m) return g1.None
          t && (e = e.bind(t))
          const n = new T1(e)
          let i, s
          this.g &&
            this.z >= Math.ceil(this.g.threshold * 0.2) &&
            ((n.stack = te.create()), (i = this.g.check(n.stack, this.z + 1))),
            Oe && (n.stack = s ?? te.create()),
            this.u
              ? this.u instanceof T1
                ? ((this.w ??= new wr()), (this.u = [this.u, n]))
                : this.u.push(n)
            ...
            this.z++
          const o = Pe(() => {
            R1?.unregister(o), i?.(), this.A(n)
          })
          if (
            (r instanceof ee ? r.add(o) : Array.isArray(r) && r.push(o), R1)
          ) {
...
`,
                ...
                .trim(),
              u = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(l)
            R1.register(o, u?.[2] ?? l, o)
          }
          return o
        }),
        this.q
    ...
    B(e, t) {
      if (!e) return
      const r = this.f?.onListenerError || $1
      if (!r) {
        e.value(t)
        return
      }
...
function Er(e, t, r = 0, n = e.length, i = 0, s = t.length) {
  for (; r < n && i < s; r++, i++) {
...
function je(e, t, r = 0, n = e.length, i = 0, s = t.length) {
  for (; r < n && i < s; r++, i++) {
    let u = e.charCodeAt(r),
      a = t.charCodeAt(i)
    if (u === a) continue
    if (u >= 128 || a >= 128)
      return Er(e.toLowerCase(), t.toLowerCase(), r, n, i, s)
    Ue(u) && (u -= 32), Ue(a) && (a -= 32)
    const f = u - a
    if (f !== 0) return f
  }
...
var Xn = class C1 {
    ...
    static {
      this.d = new Lr({ getCacheKey: JSON.stringify }, (t) => {
        function r(f) {
          const c = new Map()
          for (let d = 0; d < f.length; d += 2) c.set(f[d], f[d + 1])
          return c
        }
        function n(f, c) {
          const d = new Map(f)
          for (const [w, x] of c) d.set(w, x)
          return d
        }
        function i(f, c) {
          if (!f) return c
          const d = new Map()
          for (const [w, x] of f) c.has(w) && d.set(w, x)
          return d
        }
        const s = this.c.value
        let o = t.filter((f) => !f.startsWith("_") && f in s)
    ...
    static {
      this.e = new Ie(() =>
        Object.keys(C1.c.value).filter((t) => !t.startsWith("_")),
      )
    }
    static getLocales() {
      return C1.e.value
...
if (typeof re < "u" && typeof re.process < "u") {
  const e = re.process
  i1 = {
    get platform() {
      return e.platform
...
function Ir(e, t) {
  if (e === null || typeof e != "object") throw new We(t, "Object", e)
}
function k(e, t) {
...
var O = {
    resolve(...e) {
      ...
      for (let i = e.length - 1; i >= -1; i--) {
        ...
        if (n) {
          if (t.length > 0) break
        } else if (((r = `${s.slice(l)}\\${r}`), (n = a), a && t.length > 0))
          break
      }
      return (r = I1(r, !n, "\\", y)), n ? `${t}\\${r}` : `${t}${r}` || "."
    },
    normalize(e) {
      k(e, "path")
      const t = e.length
      ...
      if (y(s))
        if (((i = !0), y(e.charCodeAt(1)))) {
          ...
          if (l < t && l !== u) {
            ...
            if (l < t && l !== u) {
              for (u = l; l < t && !y(e.charCodeAt(l)); ) l++
              if (l === t) return `\\\\${a}\\${e.slice(u)}\\`
              l !== u && ((n = `\\\\${a}\\${e.slice(u, l)}`), (r = l))
            }
          }
        } else r = 1
      else
        r1(s) &&
          ...
          ((n = e.slice(0, 2)),
          (r = 2),
          t > 2 && y(e.charCodeAt(2)) && ((i = !0), (r = 3)))
      let o = r < t ? I1(e.slice(r), !i, "\\", y) : ""
      return (
        o.length === 0 && !i && (o = "."),
        o.length > 0 && y(e.charCodeAt(t - 1)) && (o += "\\"),
        n === void 0 ? (i ? `\\${o}` : o) : i ? `${n}\\${o}` : `${n}${o}`
      )
    },
    isAbsolute(e) {
      k(e, "path")
      ...
      return (
        y(r) || (t > 2 && r1(r) && e.charCodeAt(1) === t1 && y(e.charCodeAt(2)))
      )
    },
    join(...e) {
    ...
    relative(e, t) {
      ...
      if (d !== f) {
        ...
        o > f && (e.charCodeAt(i + d) === q ? (c = d) : d === 2 && (c = 3)),
          c === -1 && (c = 0)
      }
      let w = ""
      for (d = i + c + 1; d <= s; ++d)
        (d === s || e.charCodeAt(d) === q) &&
          (w += w.length === 0 ? ".." : "\\..")
      return (
        (l += c),
        w.length > 0
    ...
    toNamespacedPath(e) {
      ...
      if (t.charCodeAt(0) === q) {
        if (t.charCodeAt(1) === q) {
          ...
          if (r !== Mr && r !== e1) return `\\\\?\\UNC\\${t.slice(2)}`
        }
      } else if (
        r1(t.charCodeAt(0)) &&
        t.charCodeAt(1) === t1 &&
    ...
    dirname(e) {
      ...
      if (y(i)) {
        ...
        r1(i) &&
          e.charCodeAt(1) === t1 &&
          ((r = t > 2 && y(e.charCodeAt(2)) ? 3 : 2), (n = r))
      let s = -1,
        o = !0
      for (let l = t - 1; l >= n; --l)
        if (y(e.charCodeAt(l))) {
    ...
    parse(e) {
      ...
      let n = 0,
        i = e.charCodeAt(0)
      if (r === 1)
        return y(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t)
      if (y(i)) {
  ...
  E = {
    resolve(...e) {
      ...
      for (let n = e.length - 1; n >= -1 && !r; n--) {
        const i = n >= 0 ? e[n] : Ur()
        k(i, `paths[${n}]`),
          i.length !== 0 && ((t = `${i}/${t}`), (r = i.charCodeAt(0) === j))
      }
      return (t = I1(t, !r, "/", ne)), r ? `/${t}` : t.length > 0 ? t : "."
    },
    normalize(e) {
    ...
    relative(e, t) {
      if (
        (k(e, "from"),
        k(t, "to"),
        e === t || ((e = E.resolve(e)), (t = E.resolve(t)), e === t))
      )
        return ""
      const r = 1,
        n = e.length,
      ...
      if (a === l)
        if (o > l) {
          ...
          i > l && (e.charCodeAt(r + a) === j ? (u = a) : a === 0 && (u = 0))
      let f = ""
      for (a = r + u + 1; a <= n; ++a)
        (a === n || e.charCodeAt(a) === j) &&
          (f += f.length === 0 ? ".." : "/..")
      return `${f}${t.slice(s + u)}`
    },
    toNamespacedPath(e) {
      return e
    },
...
var _ = "",
  ...
  W = class W1 {
    ...
    static joinPath(t, ...r) {
      ...
      return (
        f1 && t.scheme === "file"
          ? (n = W1.file(O.join(U1(t, !0), ...r)).path)
          : (n = E.join(t.path, ...r)),
        t.with({ path: n })
      )
    }
      ...
      if (t) {
        if (t instanceof W1) return t
        {
          ...
          return (
            ...
            (r._fsPath = t._sep === Ve ? (t.fsPath ?? null) : null),
            r
          )
        }
      } else return t
...
function ie(e, t) {
  const r = t ? Xr : Be
  let n = "",
    { scheme: i, authority: s, path: o, query: l, fragment: u } = e
  if (
    (i && ((n += i), (n += ":")),
    (s || i === "file") && ((n += B), (n += B)),
    s)
    ...
    let a = s.indexOf("@")
    if (a !== -1) {
      const f = s.substr(0, a)
      ;(s = s.substr(a + 1)),
        (a = f.lastIndexOf(":")),
        a === -1
          ? (n += r(f, !1, !1))
          : ((n += r(f.substr(0, a), !1, !1)),
            (n += ":"),
            (n += r(f.substr(a + 1), !1, !0))),
        (n += "@")
    }
    ;(s = s.toLowerCase()),
      (a = s.lastIndexOf(":")),
  ...
  if (o) {
    if (o.length >= 3 && o.charCodeAt(0) === 47 && o.charCodeAt(2) === 58) {
      const a = o.charCodeAt(1)
      a >= 65 &&
        a <= 90 &&
        (o = `/${String.fromCharCode(a + 32)}:${o.substr(3)}`)
    } else if (o.length >= 2 && o.charCodeAt(1) === 58) {
      const a = o.charCodeAt(0)
      a >= 65 &&
        a <= 90 &&
        (o = `${String.fromCharCode(a + 32)}:${o.substr(2)}`)
    }
    n += r(o, !0, !1)
  }
  return (
...
function D1(e) {
  return e.match(Ke) ? e.replace(Ke, (t) => Je(t)) : e
}
var R
;(function (e) {
  ;(e.inMemory = "inmemory"),
...
var Zr = "tkn",
  Qr = class {
    ...
    rewrite(e) {
      ...
      return (
        typeof i == "string" && (s += `&${Zr}=${encodeURIComponent(i)}`),
        W.from({
  ...
  en = new Qr()
function tn(e, t) {
  return E.join(t ?? "/", `${e.quality ?? "oss"}-${e.commit ?? "dev"}`)
}
  ...
  sn = class F1 {
    ...
    uriToBrowserUri(t) {
      return t.scheme === R.vscodeRemote
        ? en.rewrite(t)
        : t.scheme === R.file &&
            (Vt || Bt === `${R.vscodeFileResource}://${F1.a}`)
          ? t.with({
...
var un = class Lt {
              ...
              window.trustedTypes?.createPolicy("amdLoader", {
                createScriptURL(t) {
                  if (
                    ...
                    t.startsWith(`${R.vscodeFileResource}://${Ge}`)
                  )
                    return t
                  throw new Error(
    ...
    async load(t) {
      ...
      if (Array.isArray(r.dependencies))
        for (const o of r.dependencies) o === "exports" ? i.push(n) : s.push(o)
      if (s.length > 0)
        throw new Error(
          `Cannot resolve dependencies for script ${t}. The dependencies are: ${s.join(", ")}`,
        )
...
async function Ze(e, t, r) {
  ...
  if (/^\w[\w\d+.-]*:\/\//.test(n)) i = n
    ...
    const u = `${ln && r && !ye ? nn : rn}/${n}`
    i = Ye.asBrowserUri(u).toString(!0)
  }
  const s = un.INSTANCE.load(i)
  return se.set(n, s), s
}
var cn = class he {
  static {
...
var oe = class {
    ...
    compare(e, t, r = !1) {
      return e === t
        ? 0
        : Ar(this.getComparisonKey(e, r), this.getComparisonKey(t, r))
    }
    isEqual(e, t, r = !1) {
      return e === t
        ? !0
    ...
    normalizePath(e) {
      ...
      return (
        e.scheme === R.file
          ? (t = W.file(Dr(X(e))).path)
          : (t = E.normalize(e.path)),
        e.with({ path: t })
      )
    }
    relativePath(e, t) {
    ...
    resolvePath(e, t) {
      if (e.scheme === R.file) {
        const r = W.file(zr(X(e), t))
        return e.with({ authority: r.authority, path: r.path })
      }
      return (t = fn(t)), e.with({ path: E.resolve(e.path, t) })
    }
    isAbsolutePath(e) {
    ...
    hasTrailingPathSeparator(e, t = j1) {
      if (e.scheme === R.file) {
        const r = X(e)
    ...
    removeTrailingPathSeparator(e, t = j1) {
      return nt(e, t)
        ? e.with({ path: e.path.substr(0, e.path.length - 1) })
        : e
    }
    addTrailingPathSeparator(e, t = j1) {
      let r = !1
      if (e.scheme === R.file) {
        const n = X(e)
      ...
      return !r && !nt(e, t) ? e.with({ path: e.path + "/" }) : e
    }
  },
  N = new oe(() => !1),
  l2 = new oe((e) => (e.scheme === R.file ? !Ft : !0)),
  a2 = new oe((e) => !0),
  u2 = N.isEqual.bind(N),
      ...
      return {
        next: async () => {
          do {
            ...
            await O1.toPromise(this.g.event)
          } while (!0)
        },
  ...
  vn = class S {
    ...
    static intersectRanges(t, r) {
      ...
      return (
        ...
        n > s || (n === s && i > o) ? null : new S(n, i, s, o)
      )
    }
...
`),
    ...
    static rangeAfterEdit(t, r) {
      const n = S.lift(t).whereIs(r.range)
      switch (n) {
        case "overlapping":
          throw new Error(
...
`) -
    ...
    setEndPosition(t, r) {
      return new S(this.startLineNumber, this.startColumn, t, r)
    }
    setStartPosition(t, r) {
      return new S(t, r, this.endLineNumber, this.endColumn)
    }
    collapseToStart() {
    ...
    static fromPositions(t, r = t) {
      return new S(t.lineNumber, t.column, r.lineNumber, r.column)
    }
    static lift(t) {
      return t
        ? new S(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn)
        : null
    }
    static isIRange(t) {
      return (
...
function gn(e = "") {
  let t = "(-?\\d*\\.\\d\\w*)|([^"
  for (const r of bn) e.indexOf(r) >= 0 || (t += "\\" + r)
...
var ut = new ar()
ut.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 })
function ct(e, t, r, n, i) {
  if (((t = at(t)), i || (i = k1.first(ut)), r.length > i.maxLen)) {
    let a = e - i.maxLen / 2
    return (
      a < 0 ? (a = 0) : (n += a),
      (r = r.substring(a, e + i.maxLen / 2)),
      ct(e, t, r, n, i)
    )
  }
  const s = Date.now(),
  ...
  let l = -1,
    u = null
  for (let a = 1; !(Date.now() - s >= i.timeBudget); a++) {
    const f = o - i.windowSize * a
...
var yn = class {
  ...
  Ln = class {
    ...
    onEvents(e) {
      ...
      for (const r of t)
        this.k(r.range),
          this.l(new p1(r.range.startLineNumber, r.range.startColumn), r.text)
  ...
  An = class {
    ...
    getModels() {
      const e = []
      return Object.keys(this.a).forEach((t) => e.push(this.a[t])), e
    }
    $acceptNewModel(e) {
  ...
  En = class extends Ln {
    ...
    getWordAtPosition(e, t) {
      const r = ct(e.column, at(t), this.b[e.lineNumber - 1], 0)
      return r
        ? new vn(e.lineNumber, r.startColumn, e.lineNumber, r.endColumn)
        : null
    }
    getWordUntilPosition(e, t) {
      const r = this.getWordAtPosition(e, t)
      return r
        ? {
            word: this.b[e.lineNumber - 1].substring(
              r.startColumn - 1,
              e.column - 1,
            ),
    ...
    getValueInRange(e) {
      if (((e = this.n(e)), e.startLineNumber === e.endLineNumber))
        return this.b[e.startLineNumber - 1].substring(
          e.startColumn - 1,
          e.endColumn - 1,
        )
      const t = this.c,
      ...
      for (let s = r + 1; s < n; s++) i.push(this.b[s])
    ...
    offsetAt(e) {
      return (
        (e = this.o(e)),
        this.h(),
        this.f.getPrefixSum(e.lineNumber - 2) + (e.column - 1)
      )
    }
    positionAt(e) {
      ;(e = Math.floor(e)), (e = Math.max(0, e)), this.h()
      const t = this.f.getIndexOf(e),
    ...
    n(e) {
      const t = this.o({
        ...
        r = this.o({ lineNumber: e.endLineNumber, column: e.endColumn })
    ...
    o(e) {
      ...
      let { lineNumber: t, column: r } = e,
        n = !1
      if (t < 1) (t = 1), (r = 1), (n = !0)
      else if (t > this.b.length)
        (t = this.b.length), (r = this.b[t - 1].length + 1), (n = !0)
      else {
        const i = this.b[t - 1].length + 1
...
var _n = class Z {
    ...
    async $detectLanguage(t, r, n, i) {
      ...
      if (!u) return
      const a = async () => {
          for await (const c of this.r(u)) {
            this.l.has(c.languageId) ||
              this.l.set(
                c.languageId,
                await this.g.$getLanguageId(c.languageId),
              )
            const d = this.l.get(c.languageId)
            d &&
              (!i?.length || i.includes(d)) &&
              (s.push(d), o.push(c.confidence))
          }
          if ((l.stop(), s.length))
            return this.g.$sendTelemetryEvent(s, o, l.elapsed()), s[0]
        },
        f = async () => this.o(u, r ?? {}, i)
      if (n) {
        const c = await f()
        if (c) return c
        const d = await a()
    ...
    async n() {
      ...
      const t = await this.g.$getRegexpModelUri()
      try {
        return (this.h = await Ze(t, "")), this.h
      } catch {
        this.i = !0
        return
      }
    ...
    async o(t, r, n) {
      ...
      if (!i) return
      if (n?.length)
        for (const o of Object.keys(r)) n.includes(o) ? (r[o] = 1) : (r[o] = 0)
      return i.detect(t, r, n)
    }
    async p() {
      if (this.j) return this.j
      const t = await this.g.$getIndexJsUri(),
        { ModelOperations: r } = await Ze(t, "")
      return (
        (this.j = new r({
          modelJsonLoaderFunc: async () => {
            const n = await fetch(await this.g.$getModelJsonUri())
            try {
              return await n.json()
            } catch {
              const s = "Failed to parse model JSON."
              throw new Error(s)
            }
          },
          weightsLoaderFunc: async () =>
            await (await fetch(await this.g.$getWeightsUri())).arrayBuffer(),
        })),
        this.j
      )
    }
    ...
    async *r(t) {
      ...
      try {
        ...
        console.log(o), (this.k = !0)
        return
      }
      let n
      try {
        n = await r.runModel(t)
      } catch (o) {
        console.warn(o)
      }
      if (!n || n.length === 0 || n[0].confidence < Z.a) return
      const i = this.q(n[0])
      if (i.confidence < Z.a) return
      const s = [i]
      for (let o of n) {
        if (o === i) continue
        if (
          ((o = this.q(o)), s[s.length - 1].confidence - o.confidence >= Z.a)
        ) {
          for (; s.length; ) yield s.shift()
          if (o.confidence > Z.a) {
            s.push(o)
            continue
          }
    ...
    listen(e, t, r) {
      ...
      const i = new K({
        onWillAddFirstListener: () => {
          ;(n = String(++this.b)),
            this.d.set(n, i),
            this.o(new Pn(this.a, n, e, t, r))
        },
        onDidRemoveLastListener: () => {
          this.d.delete(n), this.o(new On(this.a, n)), (n = null)
        },
      })
      return i.event
    }
      ...
      this.g.handleMessage(e.channel, e.method, e.args).then(
        ...
        (n) => {
          n.detail instanceof Error && (n.detail = me(n.detail)),
            this.o(new dt(this.a, t, void 0, me(n)))
        },
      )
    }
    l(e) {
...
var Rn = class {
    ...
    g(e, t, r) {
      ...
      const n = e === ae ? this.b : this.d.get(e)
      if (!n)
    ...
    async j(e, t, r) {
      ...
      return (
        ...
        import(`${Ye.asBrowserUri(`${r}.js`).toString(!0)}`).then((i) => {
...
//# sourceMappingURL=https://cursor-sourcemaps.s3.amazonaws.com/sourcemaps/f5f18731406b73244e0558ee7716d77c8096d150/core/vs/workbench/services/languageDetection/browser/languageDetectionSimpleWorkerMain.js.map

//# debugId=3c4af479-50e6-56c2-91e4-d37018decbfa
