...
var Wt = (t, n, e) =>
  n in t
    ? Gt(t, n, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (t[n] = e)
var A = (t, n, e) => Wt(t, typeof n != "symbol" ? n + "" : n, e)
function $() {}
;(function () {
...
function En(t, n) {
  return (
    t === n ||
    (G || (G = document.createElement("a")), (G.href = n), t === G.href)
  )
}
function lt(t, ...n) {
  if (t == null) {
...
function Jt(t, n, e, o) {
  if (t[2] && o) {
    ...
    if (typeof r == "object") {
      ...
      for (let a = 0; a < s; a += 1) i[a] = n.dirty[a] | r[a]
      return i
    }
    return n.dirty | r
  }
...
function Tn(t) {
  return t && q(t.destroy) ? t.destroy : $
}
function On(t) {
...
let ut = At ? () => window.performance.now() : () => Date.now(),
  ft = At ? (t) => requestAnimationFrame(t) : $
const j = new Set()
function kt(t) {
  j.forEach((n) => {
    n.c(t) || (j.delete(n), n.f())
  }),
    j.size !== 0 && ft(kt)
}
function dt(t) {
  ...
  if (U) {
    for (
      (function (e) {
        ...
        const r = new Int32Array(o.length + 1),
          i = new Int32Array(o.length)
        r[0] = -1
        let s = 0
        for (let l = 0; l < o.length; l++) {
          const f = o[l].claim_order,
            h =
              (s > 0 && o[r[s]].claim_order <= f
                ? s + 1
                : Xt(1, s, (p) => o[r[p]].claim_order, f)) - 1
          i[l] = r[h] + 1
          const d = h + 1
          ;(r[d] = l), (s = Math.max(d, s))
        }
        const a = [],
          c = []
        let u = o.length - 1
        for (let l = r[s] + 1; l != 0; l = i[l - 1]) {
          for (a.push(o[l - 1]); u >= l; u--) c.push(o[u])
          u--
        }
        for (; u >= 0; u--) c.push(o[u])
        a.reverse(), c.sort((l, f) => l.claim_order - f.claim_order)
        for (let l = 0, f = 0; l < c.length; l++) {
          for (; f < a.length && c[l].claim_order >= a[f].claim_order; ) f++
          const h = f < a.length ? a[f] : null
          e.insertBefore(c[l], h)
        }
      })(t),
...
function tn(t, n, e) {
  U && !e
    ? Zt(t, n)
    : (n.parentNode === t && n.nextSibling == e) || t.insertBefore(n, e || null)
}
function k(t) {
  ...
  for (const o in n)
    n[o] == null
      ...
      : o === "style"
        ...
        : o === "__value"
          ? (t.value = t[o] = n[o])
          : e[o] && e[o].set && en.indexOf(o) === -1
            ? (t[o] = n[o])
            : v(t, o, n[o])
}
function Sn(t, n) {
  for (const e in n) v(t, e, n[e])
}
function on(t, n) {
...
function rn(t, n, e) {
  ...
  o in t
    ? (t[o] = (typeof t[o] == "boolean" && e === "") || e)
    : n in t
      ? (t[n] = (typeof t[n] == "boolean" && e === "") || e)
      : v(t, n, e)
}
function Ln(t) {
  return /-/.test(t) ? on : rt
...
function cn(t, n, e, o) {
  return (function (r, i, s, a, c = !1) {
    Tt(r)
    const u = (() => {
      for (let l = r.claim_info.last_index; l < r.length; l++) {
        const f = r[l]
        if (i(f)) {
          const h = s(f)
          return (
            h === void 0 ? r.splice(l, 1) : (r[l] = h),
            c || (r.claim_info.last_index = l),
            f
          )
        }
      }
      for (let l = r.claim_info.last_index - 1; l >= 0; l--) {
        const f = r[l]
        if (i(f)) {
          const h = s(f)
          return (
            h === void 0 ? r.splice(l, 1) : (r[l] = h),
            c
              ? h === void 0 && r.claim_info.last_index--
              : (r.claim_info.last_index = l),
            f
          )
        }
      }
    ...
    return (
      (u.claim_order = r.claim_info.total_claimed),
    ...
    (r) => {
      ...
      i.forEach((s) => r.removeAttribute(s))
    },
    () => o(n),
  )
}
...
function bt(t, n, e) {
  for (let o = e; o < t.length; o += 1) {
    const r = t[o]
    if (r.nodeType === 8 && r.textContent.trim() === n) return o
  }
  return -1
}
function Dn(t, n) {
  const e = bt(t, "HTML_TAG_START", 0),
    o = bt(t, "HTML_TAG_END", e + 1)
  if (e === -1 || o === -1) return new et(n)
  Tt(t)
  const r = t.splice(e, o - e + 1)
  k(r[0]), k(r[r.length - 1])
  const i = r.slice(1, r.length - 1)
  if (i.length === 0) return new et(n)
  for (const s of i)
  ...
  return (
    o
      ? ((e.src =
        ...
        (r = _t(window, "message", (i) => {
          i.source === e.contentWindow && n()
        })))
      : ((e.src = "about:blank"),
        (e.onload = () => {
          ;(r = _t(e.contentWindow, "resize", n)), n()
        })),
    y(t, e),
    () => {
      ;(o || (r && e.contentWindow)) && r(), k(e)
    }
  )
}
function L(t, n, e) {
...
function Ot(t, n, { bubbles: e = !1, cancelable: o = !1 } = {}) {
...
class ln {
  ...
  i(n) {
    for (let e = 0; e < this.n.length; e += 1) nt(this.t, this.n[e], n)
  }
  p(n) {
...
class et extends ln {
  constructor(e = !1, o) {
    super(e)
    A(this, "l")
    ;(this.e = this.n = null), (this.l = o)
  }
  c(e) {
    this.l ? (this.n = this.l) : super.c(e)
  }
  i(e) {
    for (let o = 0; o < this.n.length; o += 1) tn(this.t, this.n[o], e)
  }
}
function Wn(t, n) {
  return new t(n)
...
`
  ...
  const l =
    ...
    f = `__svelte_${(function (g) {
      let _ = 5381,
        b = g.length
      for (; b--; ) _ = ((_ << 5) - _) ^ g.charCodeAt(b)
      return _ >>> 0
    })(l)}_${a}`,
    h = Nt(t),
    { stylesheet: d, rules: p } =
      V.get(h) ||
      (function (g, _) {
        const b = { stylesheet: Yt(_), rules: {} }
        return V.set(g, b), b
      })(h, t)
  p[f] || ((p[f] = !0), d.insertRule(`@keyframes ${f} ${l}`, d.cssRules.length))
  const m = t.style.animation || ""
  return (
    (t.style.animation = `${m ? `${m}, ` : ""}${f} ${o}ms linear ${r}ms 1 both`),
    (K += 1),
    f
  )
}
function Y(t, n) {
  const e = (t.style.animation || "").split(", "),
    o = e.filter(
      n ? (i) => i.indexOf(n) < 0 : (i) => i.indexOf("__svelte") === -1,
    ),
    r = e.length - o.length
  r &&
    ...
    K ||
      ft(() => {
        K ||
          (V.forEach((i) => {
            const { ownerNode: s } = i.stylesheet
            s && k(s)
          }),
          V.clear())
      }))
...
function Pt() {
  ...
  do {
    try {
      ...
      throw ((S.length = 0), (M = 0), n)
    }
    for (F(null), S.length = 0, M = 0; yt.length; ) yt.pop()()
...
function ee(t, n, e) {
  ...
  function l() {
    ...
    i && i.abort(),
      ...
      (i = dt((x) => {
        if (a) {
          if (x >= b) return m(1, 0), T(t, !0, "end"), u(), (a = !1)
          if (x >= _) {
            const z = p((x - _) / d)
            m(z, 1 - z)
          }
  ...
  return {
    start() {
      f || ((f = !0), Y(t), q(s) ? ((s = s(o)), ht().then(l)) : l())
    },
    invalidate() {
      f = !1
    },
...
function oe(t, n, e) {
  ...
  function u() {
    ...
    B(() => T(t, !1, "start")),
      ...
      dt((_) => {
        if (s) {
          if (_ >= g) return d(0, 1), T(t, !1, "end"), --a.r || N(a.c), !1
          if (_ >= m) {
            const b = h((_ - m) / f)
            d(1 - b, b)
          }
          ...
          dt((z) => {
            if (
              (c &&
                ...
                (c = null),
                T(t, a.b, "start"),
                b && (l(), (u = X(t, s, a.b, a.duration, 0, g, i.css)))),
              a)
            ) {
              if (z >= a.end)
                _((s = a.b), 1 - s),
                  T(t, a.b, "end"),
                  c || (a.b ? l() : --a.group.r || N(a.group.c)),
                  (a = null)
              else if (z >= a.start) {
                const Rt = z - a.start
                ;(s = a.a + a.d * g(Rt / a.duration)), _(s, 1 - s)
              }
            }
            return !(!a && !c)
          }))
...
function dn(t, n) {
  ...
  for (; i--; ) {
    const s = t[i],
      a = n[i]
    if (a) {
      for (const c in s) c in a || (o[c] = 1)
      for (const c in a) r[c] || ((e[c] = a[c]), (r[c] = 1))
      t[i] = a
...
function mountComponent(t, n, e) {
  ...
  o && o.m(n, e),
    B(() => {
      const i = t.$$.on_mount.map(xt).filter(q)
      t.$$.on_destroy ? t.$$.on_destroy.push(...i) : N(i), (t.$$.on_mount = [])
    }),
    r.forEach(B)
}
function destroyComponent(t, n) {
  ...
  e.fragment !== null &&
    ((function (o) {
      const r = [],
        i = []
      D.forEach((s) => (o.indexOf(s) === -1 ? r.push(s) : i.push(s))),
        i.forEach((s) => s()),
        (D = r)
    })(e.after_update),
    N(e.on_destroy),
...
const P = []
function mn(t, n) {
  return { subscribe: Dt(t, n).subscribe }
}
function Dt(t, n = $) {
  let e
  const o = new Set()
  function r(s) {
    if (notEqual(t, s) && ((t = s), e)) {
      ...
      if (a) {
        for (let c = 0; c < P.length; c += 2) P[c][0](P[c + 1])
        P.length = 0
      }
    }
  }
  ...
  return {
    ...
    subscribe: function (s, a = $) {
      ...
      return (
        ...
        s(t),
        () => {
          o.delete(c), o.size === 0 && e && (e(), (e = null))
        }
      )
    },
  }
...
let gn = document.documentElement
function O() {
  return gn ?? document.documentElement
}
var Bt = ((t) => ((t.light = "light"), (t.dark = "dark"), t))(Bt || {}),
  It = ((t) => (
    (t.regular = "regular"), (t.highContrast = "high-contrast"), t
  ))(It || {})
const Z = "data-augment-theme-category",
  tt = "data-augment-theme-intensity"
function Ft() {
  const t = O().getAttribute(Z)
  if (t && Object.values(Bt).includes(t)) return t
}
function ue(t) {
  t === void 0 ? O().removeAttribute(Z) : O().setAttribute(Z, t)
}
function Ht() {
  const t = O().getAttribute(tt)
  if (t && Object.values(It).includes(t)) return t
}
function fe(t) {
  t === void 0 ? O().removeAttribute(tt) : O().setAttribute(tt, t)
}
const $t = Dt(void 0)
function _n(t) {
  ...
  return n.observe(O(), { attributeFilter: [Z, tt], attributes: !0 }), n
}
_n((t, n) => {
  $t.update(() => ({ category: t, intensity: n }))
}),
  $t.update(() => ({ category: Ft(), intensity: Ht() })),
  typeof window < "u" &&
...
function vt(t) {
  return { "data-ds-color": t }
}
function pe(t) {
  return { "data-ds-radius": t }
}
function me(t, n, e) {
  return e ? { [`data-ds-${t}-${n}`]: !0, [`data-${n}`]: !0 } : {}
}
function bn(t) {
  let n, e, o
  const r = t[7].default,
  ...
  let s = [
    ...
    a = {}
  for (let c = 0; c < s.length; c += 1) a = Q(a, s[c])
  return {
    c() {
      ;(n = w("span")),
        i && i.c(),
        rt(n, a),
        L(n, "c-text--has-color", t[3] !== void 0),
        L(n, "svelte-9qsk6o", !0)
    },
    m(c, u) {
      nt(c, n, u), i && i.m(n, null), (o = !0)
    },
    p(c, [u]) {
      i &&
        i.p &&
        (!o || 64 & u) &&
        Qt(i, r, c, c[6], o ? Jt(r, c[6], u, null) : Ut(c[6]), null),
        rt(
          n,
          (a = dn(s, [
            8 & u && (c[3] ? vt(c[3]) : {}),
        ...
        L(n, "c-text--has-color", c[3] !== void 0),
        L(n, "svelte-9qsk6o", !0)
    },
    i(c) {
...
function yn(t, n, e) {
  let o, r
  const i = ["size", "weight", "type", "color"]
  let s = gt(n, i),
    { $$slots: a = {}, $$scope: c } = n,
    { size: u = 3 } = n,
    { weight: l = "regular" } = n,
  ...
  return (
    (t.$$set = (d) => {
      ;(n = Q(Q({}, n), Vt(d))),
        e(8, (s = gt(n, i))),
        "size" in d && e(0, (u = d.size)),
        "weight" in d && e(1, (l = d.weight)),
        "type" in d && e(2, (f = d.type)),
        "color" in d && e(3, (h = d.color)),
        "$$scope" in d && e(6, (c = d.$$scope))
    }),
    (t.$$.update = () => {
      e(5, ({ class: o, ...r } = s), o, (e(4, r), e(8, s)))
    }),
    [u, l, f, h, r, o, c, a]
  )
}
...
function wt(t) {
  let n, e, o, r, i, s, a, c, u, l, f, h, d, p, m, g, _
  return {
    c() {
      ;(n = w("div")),
        (e = w("div")),
        ...
        (m = C()),
        (g = w("div")),
        v(e, "class", "c-spinner__leaf svelte-abmqgo"),
        v(r, "class", "c-spinner__leaf svelte-abmqgo"),
        v(s, "class", "c-spinner__leaf svelte-abmqgo"),
        v(c, "class", "c-spinner__leaf svelte-abmqgo"),
        v(l, "class", "c-spinner__leaf svelte-abmqgo"),
        v(h, "class", "c-spinner__leaf svelte-abmqgo"),
        v(p, "class", "c-spinner__leaf svelte-abmqgo"),
        v(g, "class", "c-spinner__leaf svelte-abmqgo"),
        v(
          n,
          "class",
          (_ =
            "c-spinner c-spinner--size-$" +
            t[0] +
            " " +
            t[3] +
            " svelte-abmqgo"),
        ),
        v(n, "data-testid", "spinner-augment"),
        L(n, "c-spinner--current-color", t[2])
    },
    m(b, x) {
      nt(b, n, x),
        y(n, e),
      ...
      9 & x &&
        _ !==
          (_ =
            ...
            " svelte-abmqgo") &&
        v(n, "class", _),
        13 & x && L(n, "c-spinner--current-color", b[2])
    },
    d(b) {
      b && k(n)
    },
...
function vn(t, n, e) {
  let { size: o = 2 } = n,
    { loading: r = !0 } = n,
    { useCurrentColor: i = !1 } = n,
    { class: s = "" } = n
  return (
    (t.$$set = (a) => {
      "size" in a && e(0, (o = a.size)),
        "loading" in a && e(1, (r = a.loading)),
        "useCurrentColor" in a && e(2, (i = a.useCurrentColor)),
        "class" in a && e(3, (s = a.class))
    }),
    [o, r, i, s]
  )
}
